...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:edirom="http://www.edirom.de"
    xmlns:xs="http://www.w3.org/2001/XMLSchema"
    xmlns:eof="http://www.edirom.de/xslt/ediromOnlineFunctions"
    xmlns:mei="http://www.music-encoding.org/ns/mei" xmlns:fo="http://www.w3.org/1999/XSL/Format"
    xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" exclude-result-prefixes="xs xd fo mei edirom"
    xml:space="default" version="2.0">
        ...
        <xsl:for-each select="//mei:mdiv">
            <div class="partMeasureSurfaceTabel">
                ...
                <xsl:for-each-group select=".//mei:measure"
                    group-by="
                        .//id(if (contains(@facs, '#')) then
                            (substring-after(@facs, '#'))
                        else
                            (./@facs))/parent::mei:surface/@xml:id">
                    <dl>
                        <dt>
                            <xsl:value-of
                                select="current-group()[1]/@n | current-group()[last()]/@n"
                                separator="–"/>
                        </dt>
                        <dd>
